...
int main() {
    ...
    vector<vector<int>> vec = {{1, 1, 1},
                               {1, 1, 0},
                               {1, 0, 1}};
    vector<vector<string>> vec_str = {{"a", "b"},
                                      {"c", "d"}};
    vector<vector<string>> vec_str2 = {{"a", "c"},
                                       {"b", "a"}};
    vector<double> vec_d = {2, 3};
    vector<vector<int>> redEdges = {{95, 4},
                                    {95, 38},
                                    {56, 93},
                                    {98, 81},
                                    {22, 76},
                                    ...
                                    {43, 56},
                                    {68, 59}};
    vector<vector<int>> blueEdges = {{81, 24},
                                     {98, 66},
                                     {15, 66},
                                     {78, 20},
                                     {14, 4},
...
//    tree1.inOrderNonRecur(root);
    ...
    vector<int> vec_init2(10, 0);  // 10 is size
